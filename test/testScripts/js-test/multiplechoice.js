...
const XPATH_MULTIPLE_DISABLE_ITEM = '.multiple-disable .kuc-list-item';
const XPATH_MULTIPLE_DISABLE_BUTTON = '.multiple-disable .disable-multiple';
const XPATH_MULTIPLE_ENABLE_ITEM = '.multiple-enable .kuc-list-item';
...
describe('kintoneUIComponent - Button', function () {
    ...
    it('[MultipleChoice-79] Verify that can disable the current enable MultipleChoice on UI', function () {
        Helper.ElementHandler
            .verifyAttributeIsNotIncludeValue(XPATH_MULTIPLE_DISABLE_ITEM + ':nth-child(1)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_DISABLE_ITEM + ':nth-child(2)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_DISABLE_ITEM + ':nth-child(3)', 'class', 'kuc-list-item-disable')
            .click(XPATH_MULTIPLE_DISABLE_BUTTON)
            .verifyAttribute(XPATH_MULTIPLE_DISABLE_ITEM + ':nth-child(1)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_DISABLE_ITEM + ':nth-child(2)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_DISABLE_ITEM + ':nth-child(3)', 'class', 'kuc-list-item-disable')
    });
    it('[MultipleChoice-81] Verify that can enable the disabled MultipleChoice on UI', function () {
        Helper.ElementHandler
            .verifyAttribute(XPATH_MULTIPLE_ENABLE_ITEM + ':nth-child(1)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_ENABLE_ITEM + ':nth-child(2)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_ENABLE_ITEM + ':nth-child(3)', 'class', 'kuc-list-item-disable')
            .click(XPATH_MULTIPLE_ENABLE_BUTTON)
            .verifyAttributeIsNotIncludeValue(XPATH_MULTIPLE_ENABLE_ITEM + ':nth-child(1)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_ENABLE_ITEM + ':nth-child(2)', 'class', 'kuc-list-item-disable')
            .verifyAttribute(XPATH_MULTIPLE_ENABLE_ITEM + ':nth-child(3)', 'class', 'kuc-list-item-disable')
    });
