...
var constructorTable = new Table({
    // initial table data
    data: initialData,
...
setValueTable.setValue([
    {
        ...
        fruit: {value:'Orange', name: 'fruit_2',
        items: [
        {
            label: 'Orange',
            value: 'Orange',
...
var showInvisibleTable = new Table({
    isVisible: false,
    // inital table data
    data: [
...
var showVisibleTable = new Table({
    isVisible: true,
    // inital table data
    data: [
    {text: { value: 'this is a text field' }}
...
showTableDiv.appendChild(showInvisibleTableEl);
showTableDiv.appendChild(showVisibleTableEl);

//hide invisible and visible Table
var hideVisibleTable = new Table({
    isVisible: true,
    // inital table data
    data: [
    {text: { value: 'this is a text field' }}
...
var hideInvisibleTable = new Table({
    isVisible: false,
    // inital table data
    data: [
    {text: { value: 'this is a text field' }}
...
let hideTableDiv = document.createElement('div');
hideTableDiv.appendChild(hideVisibleTableEl);
hideTableDiv.appendChild(hideInvisibleTableEl);
...
var rowCallBackTable = new Table({
// initial table data
data: initialData,
// default row data on row add
defaultRowData: defaultRowData,
